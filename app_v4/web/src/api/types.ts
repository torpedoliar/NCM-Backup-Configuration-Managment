...
export interface SwitchRecord { id: number; name: string; ip: string; host: string; protocol: string; port: number; credential_id: number; credential?: { id: number; name: string }; notes?: string | null; is_active: boolean; model?: string | null; }
export interface CredentialRecord { id: number; name: string; username?: string; created_at?: string | null; updated_at?: string | null; }
export interface BackupRecord { id: number; switch_id: number; switch_name?: string | null; switch_model?: string | null; switch_seq?: number | null; backup_type: string; success: boolean; file_path?: string | null; created_at: string; message?: string | null; content_hash?: string; size_bytes?: number; }
