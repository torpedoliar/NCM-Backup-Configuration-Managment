...
export const API_REF: ApiRefEntry[] = [
  ...
  { method: 'DELETE', path: '/api/v1/reviews/{review_id}', tag: 'config-reviews', auth: 'JWT admin/operator or key reviews:write', summary: 'delete_review' },
  ...
  { method: 'POST', path: '/api/v1/baselines/{baseline_id}/prepare-review', tag: 'config-reviews', auth: 'JWT (admin/operator)', summary: 'prepare_baseline_review' },
  ...
  { method: 'POST', path: '/api/v1/reviews/reminder', tag: 'config-reviews', auth: 'JWT (admin/operator)', summary: 'trigger_review_reminder' },
  ...
  { method: 'POST', path: '/api/v1/switches/sync-dataguard', tag: 'switches', auth: 'JWT admin/operator or key switches:write', summary: 'sync_switches_from_dataguard' },
...
export const ENDPOINT_DESCRIPTIONS: Record<string, string> = {
  ...
  'DELETE /api/v1/reviews/{review_id}': 'Hapus riwayat tiket review konfigurasi',
  ...
  'POST /api/v1/baselines/{baseline_id}/prepare-review': 'Siapkan sesi review perbandingan Golden Baseline vs Backup Terakhir',
  ...
  'POST /api/v1/reviews/reminder': 'Kirim email pengingat (reminder) review konfigurasi',
  ...
  'POST /api/v1/switches/sync-dataguard': 'Sinkronkan nama switch dari inventori perangkat DataGuard',
